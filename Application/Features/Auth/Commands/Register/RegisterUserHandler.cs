...
public class RegisterUserHandler(IUnitOfWork unitOfWork, IAuthRepository authRepository, RegisterUserCommandValidator commandValidator) : IRequestHandler<RegisterUserCommand, User?>
{
